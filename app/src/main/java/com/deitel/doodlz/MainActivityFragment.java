   ...
   public boolean onOptionsItemSelected(MenuItem item) {
      ...
      switch (item.getItemId()) {
         case R.id.color:
            ...
            Log.d( "DEBUG", "dialog shown" );
            return true; // consume the menu event
         case R.id.bg_color:
            ColorDialogFragment bgColorDialog = new ColorDialogFragment();
            bgColorDialog.setPurpose( ColorDialogFragment.PURPOSE_BACKGROUND );
            bgColorDialog.show(getFragmentManager(), "bg color dialog");
            return true; // consume the menu event
         case R.id.bg_image:
            ChooseImageDialogFragment cImageDialog = new ChooseImageDialogFragment();
            cImageDialog.show(getFragmentManager(), "bg image dialog");
            return true; // consume the menu event
