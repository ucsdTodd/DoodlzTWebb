...
public class ColorDialogFragment extends DialogFragment {
   ...
   public final static int PURPOSE_FOREGROUND = 0;

   public final static int PURPOSE_BACKGROUND = 1;
   ...
   private int purpose = PURPOSE_FOREGROUND;

   public void setPurpose( final int colorSetting ){
      purpose = colorSetting == PURPOSE_BACKGROUND? PURPOSE_BACKGROUND : PURPOSE_FOREGROUND;
   }
   ...
   public Dialog onCreateDialog(Bundle bundle) {
      ...
      builder.setTitle( purpose == PURPOSE_BACKGROUND?
              R.string.title_bg_color_dialog : R.string.title_color_dialog);
